...
class DocumentMetadataReceiverTest {
  ...
  @Test
  fun `returns fetch failure when fetch document is failed`() {
  ...
  @Test
  fun `returns failure when embed document is failed`() {
  ...
  @Test
  fun `returns failure when store document is failed`() {
